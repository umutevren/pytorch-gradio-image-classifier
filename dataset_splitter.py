...
dataset_path = r"C:\Users\mertc\Downloads\Compressed\archive_2\raw-img"  # Replace with your dataset path
train_path = "animal_dataset/train"  # Replace with your desired train directory path
test_path = "animal_dataset/test"  # Replace with your desired test directory path
